...
const AdminBodyMeasurementPage = () => {
  ...
  const getSummaryMeasurements = (): any => {
    ...
    // Check if measurements property exists and is an object
    if (!latestMeasurement.measurements || typeof latestMeasurement.measurements !== 'object') {
      return [
        { label: 'Chest', value: '--' },
        { label: 'Waist', value: '--' },
        { label: 'Hips', value: '--' },
  ...
  const getUniqueSectionNames = () => {
    ...
    filteredMeasurements.forEach((item: Measurement) => {
      // Check if measurements exists and is an object
      if (!item.measurements || typeof item.measurements !== 'object') return;
