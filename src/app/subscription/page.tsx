...
// import { CheckCircle, XCircle, Package, CreditCard, Check, Building, ShieldCheck } from 'lucide-react';
...
//       // Reset verification badge if business type changes to unregistered
...
//       // Reset verification badge if visibility changes to private
//       if (field === 'visibility' && value === 'private') {
//         updated.verifiedBadge = false;
//       }
      
//       // Clear identification details if identification type changes
...
//     // Validate registration number for registered businesses
...
//     // Validate owner identification for registered businesses
...
//                   {selectedPackages[pkg.id] 
//                     ? `Selected: ${selectedPackages[pkg.id]} - $${getBillingPrice(pkg, selectedPackages[pkg.id]!).toFixed(2)}` 
//                     : 'Not selected'}
//                 </span>
//                 {selectedPackages[pkg.id] && (
//                   <button
...
//               {/* Registration Number - Shows only for registered businesses */}
...
//               {/* Business Owner Verification - Shows only for registered businesses */}
//               {organizationDetails.type === 'registered' && (
//                 <div>
...
//                   {organizationDetails.type === 'registered' ? '4.' : '2.'} Make my organization's profile visible to the public
//                 </h3>
//                 <div className="flex gap-6">
//                   <label className="flex items-center cursor-pointer">
//                     <input
...
//                   Note: Visibility of your organization's profile to the public showcases your products & services and increases revenue generation.
//                 </p>
//               </div>

//               {/* Verified Badge Option - Shows only for public visibility */}
//               {organizationDetails.visibility === 'public' && (
//                 <div>
//                   <h3 className="font-semibold text-gray-900 mb-3">
//                     {organizationDetails.type === 'registered' ? '5.' : '3.'} Do you want to be verified organisation to gain prospective customers trust and get more preferential patronage?
//                   </h3>
//                   <div className="flex gap-6">
//                     <label className="flex items-center cursor-pointer">
//                       <input
...
//                   {/* Additional verification info for verified badge */}
...
//                             A verified badge helps build trust with customers and increases your organization's credibility.
//                             {organizationDetails.type === 'registered' && 
...
//                       {/* Additional requirement notice for unregistered businesses */}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {Object.keys(selectedPackages).length > 0 && (
          <div className="mb-8 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Step 3: Professional Trade Association (Optional)</h2>
        ...
        {Object.keys(selectedPackages).length > 0 && (
          <div className="mb-8 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">Step 4: Gallery (Optional)</h2>
              <button
                onClick={addProduct}
        ...
        {Object.keys(selectedPackages).length > 0 && (
          <div className="mb-8 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">Step 5: Availability & Location (Optional)</h2>
              <button
                onClick={addLocation}
                className="flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm font-medium"
              >
